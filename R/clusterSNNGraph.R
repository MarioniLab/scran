...
.clusterXNNGraph <- function(x, ..., transposed=FALSE, use.kmeans=FALSE, kmeans.centers=NULL, 
    kmeans.args=list(), graphFUN, clusterFUN) 
{
    if (!transposed) {
        x <- t(x)
    }
...
.clusterKNNGraph <- function(x, ..., clusterFUN=cluster_walktrap, 
    transposed=FALSE, use.kmeans=FALSE, kmeans.centers=NULL, kmeans.args=list()) 
{
    .clusterXNNGraph(x=x, ..., clusterFUN=clusterFUN, transposed=transposed,
        ...
        graphFUN=buildKNNGraph)
}

#' @importFrom igraph cluster_walktrap
.clusterSNNGraph <- function(x, ..., clusterFUN=cluster_walktrap, 
    transposed=FALSE, use.kmeans=FALSE, kmeans.centers=NULL, kmeans.args=list()) 
{
    .clusterXNNGraph(x=x, ..., clusterFUN=clusterFUN, transposed=transposed,
        use.kmeans=use.kmeans, kmeans.centers=kmeans.centers, kmeans.args=kmeans.args,
        graphFUN=buildSNNGraph)
}
