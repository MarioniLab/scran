...
#'
#' This function is deprecated as these statistics are automatically computed in the \code{scoreMarkers} function from the \pkg{scrapper} package.
#'
...
.summary_marker_stats <- function(x, groups, row.data=NULL, average="mean", BPPARAM=SerialParam()) {
    .Deprecated(old = "summaryMarkerStats")
