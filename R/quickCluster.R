...
setMethod("quickCluster", "matrix", function(x, min.size=200, subset.row=NULL, get.ranks=FALSE, ...)  
...
{   
    ...
    distM <- .Call(cxx_compute_cordist, x, subset.row - 1L, get.ranks) # taken into C++ to improve memory efficiency.
