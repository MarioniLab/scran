...
clusters <- quickCluster(larger.sce, subset.row=high.ab)
larger.sce <- computeSumFactors(larger.sce, cluster=clusters, subset.row=high.ab)
```

Note the use of `high.ab` to only use high-abundance genes during normalization.
This provides some protection against zero or negative size factor estimates.
