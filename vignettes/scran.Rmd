...
See `r Biocpkg("simpleSingleCell", vignette="var.html", label="this workflow")` for more discussion about variance modelling with `trendVar` and `decomposeVar`.
...
We suggest reading `r Biocpkg("simpleSingleCell", vignette="batch.html", label="this workflow")` for more details.
