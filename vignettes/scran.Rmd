...
Also see http://bioconductor.org/packages/release/workflows/html/simpleSingleCell.html for a workflow where all these steps are used in real data analyses.
...
Further information can be obtained by examining the documentation for each function (e.g., `?convertTo`);
    reading the [simpleSingleCell workflow](http://bioconductor.org/packages/release/workflows/html/simpleSingleCell.html);
